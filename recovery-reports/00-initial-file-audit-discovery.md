...
- 114 tracked files total (corrected on review — see note at top; was misstated as 112).
...
- 24 vendored `mistune` files: not individually confirmed dead, flagged as a decision point rather than asserted (corrected on review — `__main__.py` was omitted from the original count of 23; see above).
