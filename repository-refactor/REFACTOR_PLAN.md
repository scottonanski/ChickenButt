...
implementation has begun.** Phases 1 through 3 are merged and verified:
settings behavior is characterized and extracted, and composer geometry is
characterized for its Phase 4 extraction. Unstarted phases remain proposals
until work begins on their bounded phase branch.
...
cutover is not possible. Phases 1 through 3 are complete. The remaining
...
Phases 1 through 3 are complete. Unstarted rows remain proposals that Scott may
